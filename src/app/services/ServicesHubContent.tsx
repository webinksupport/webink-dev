            ...
            {services.map((svc, i) => {
              ...
              return (
                ...
                >
                  <Link
                    href={svc.href}
                    className="group relative flex flex-col bg-white rounded-2xl p-8 border border-[#E5E5E5] hover:border-[#14EAEA] hover:shadow-[0_8px_40px_rgba(20,234,234,0.15)] transition-all duration-300 cursor-pointer h-full"
                  >
                    {/* Icon circle */}
                    <div
