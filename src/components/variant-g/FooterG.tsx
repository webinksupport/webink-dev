      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid md:grid-cols-4 gap-10 mb-14">
            ...
            <div className="flex gap-4">
              {['Instagram', 'Facebook', 'LinkedIn', 'Twitter'].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="font-urbanist text-xs text-white/25 hover:text-[#14EAEA] transition-colors font-semibold"
                >
                  {s}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Web Design', 'SEO Services', 'Digital Marketing', 'Social Media', 'Web Hosting', 'Branding'].map((s) => (
                <li key={s}>
                  <Link href="/services" className="font-urbanist text-sm text-white/40 hover:text-white transition-colors">
                    {s}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 font-urbanist text-sm text-white/40">
              <li>(941) 840-1381</li>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-wrap gap-4 items-center justify-between">
          <p className="font-urbanist text-xs text-white/20">
            © 2026 Webink Solutions LLC. All rights reserved.
          </p>
          <div className="flex gap-5">
            {['Privacy Policy', 'Terms', 'Refunds'].map((s) => (
              <Link key={s} href="#" className="font-urbanist text-xs text-white/20 hover:text-white/50 transition-colors">
                {s}
              </Link>
            ))}
          </div>
