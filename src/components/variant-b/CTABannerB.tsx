      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-24 lg:py-32">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-[#14EAEA] text-black font-inter text-[11px] font-black px-10 py-4 tracking-[0.2em] uppercase hover:bg-[#14EAEA]/80 transition-all duration-200"
            ...
            <Link
              href="tel:9418401381"
              className="inline-flex items-center gap-2 border border-white/10 text-white/40 font-inter text-[11px] font-bold px-10 py-4 tracking-[0.2em] uppercase hover:border-white/30 hover:text-white/70 transition-all duration-200"
            >
