  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center bg-[#0F0F0F] overflow-hidden">
        <div className="absolute inset-0" data-type="background" data-page={pageSlug || 'services'} data-block="hero_bg">
          <Image
            src={heroImage}
            alt="Hero background"
            fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 lg:px-24 py-32">
          ...
          >
            <p
              data-page={pageSlug || 'services'} data-block="hero_subtext"
      ...
      <section className="bg-white px-6 md:px-16 lg:px-24 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p
              data-page={pageSlug || 'services'} data-block="features_eyebrow"
          ...
          >
            <h2
              data-page={pageSlug || 'services'} data-block="features_heading"
      ...
      <section className="bg-[#F8F8F8] px-6 md:px-16 lg:px-24 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p
              data-page={pageSlug || 'services'} data-block="process_eyebrow"
              className="text-[#14EAEA] text-xs font-bold tracking-[3px] uppercase mb-4"
            >
              Our Process
            </p>
          ...
          >
            <h2
              data-page={pageSlug || 'services'} data-block="process_heading"
              className="font-urbanist font-black text-[#1A1A1A] mb-16 leading-tight"
              style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', letterSpacing: '-0.03em' }}
            >
              How We Work
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
              ...
              >
                <div className="relative h-[350px] lg:h-[480px]">
                  <Image
                    data-page={pageSlug || 'services'} data-block="team_photo_main"
                    src={photos[2].src}
                    alt={photos[2].alt}
                    fill
                    className="object-cover"
              ...
              >
                <p
                  data-page={pageSlug || 'services'} data-block="team_eyebrow"
                  className="text-[#14EAEA] text-xs font-bold tracking-[3px] uppercase mb-4"
                >
                  Real People, Real Results
                </p>
                <h2
                  data-page={pageSlug || 'services'} data-block="team_heading"
                ...
                <p
                  data-page={pageSlug || 'services'} data-block="team_body_1"
                ...
                <p
                  data-page={pageSlug || 'services'} data-block="team_body_2"
      ...
      {pricing && pricing.length > 0 && (
        <section id="pricing" className="bg-white px-6 md:px-16 lg:px-24 py-20 lg:py-32">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <p
                data-page={pageSlug || 'services'} data-block="pricing_eyebrow"
                className="text-[#F813BE] text-xs font-bold tracking-[3px] uppercase mb-4"
              >
                Pricing
              </p>
            ...
            >
              <h2
                data-page={pageSlug || 'services'} data-block="pricing_heading"
                className="font-urbanist font-black text-[#1A1A1A] mb-6 leading-tight"
                style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', letterSpacing: '-0.03em' }}
              >
                Transparent Pricing
            ...
            >
              <p
                data-page={pageSlug || 'services'} data-block="pricing_subtext"
      ...
      <section className="bg-[#F8F8F8] px-6 md:px-16 lg:px-24 py-20 lg:py-32">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <p
              data-page={pageSlug || 'services'} data-block="faq_eyebrow"
              className="text-[#14EAEA] text-xs font-bold tracking-[3px] uppercase mb-4"
            >
              FAQ
            </p>
          ...
          >
            <h2
              data-page={pageSlug || 'services'} data-block="faq_heading"
      ...
      <section className="bg-[#0F0F0F] px-6 md:px-16 lg:px-24 py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p
              data-page={pageSlug || 'services'} data-block="cta_eyebrow"
              className="text-[#F813BE] text-xs font-bold tracking-[3px] uppercase mb-4"
            >
              Let&apos;s Talk
            </p>
          ...
          >
            <h2
              data-page={pageSlug || 'services'} data-block="cta_heading"
          ...
          >
            <p
              data-page={pageSlug || 'services'} data-block="cta_subtext"
          ...
          >
            ...
            >
              <span data-page={pageSlug || 'services'} data-block="cta_button_text">{ctaText}</span>
            </Link>
            <a
              href="tel:9418401381"
              onClick={(e) => { if (editMode) { e.preventDefault(); e.stopPropagation() } }}
            ...
            >
              <span data-page={pageSlug || 'services'} data-block="cta_phone_text">Call (941) 840-1381</span>
            </a>
          </motion.div>
        </div>
      </section>
