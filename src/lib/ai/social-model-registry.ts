...
const IMAGE_MODELS: ModelEntry[] = [
  ...
  // Together AI — GPT Image, Wan, Qwen
  {
    id: 'openai/gpt-image-1.5',
    name: 'GPT Image 1.5 (Together)',
    provider: 'together',
    type: 'image',
    supportsReferenceImages: false,
    referenceImageMode: null,
    ...
    costTier: 'medium',
    notes: 'Via Together AI. Text-to-image only.',
  },
  {
  ...
  // Together AI — Google models via Together
  {
    id: 'google/gemini-3-nano-banana-pro',
    name: 'Gemini 3 Pro Image (Together)',
    provider: 'together',
    type: 'image',
    supportsReferenceImages: true,
    referenceImageMode: 'multi-url',
    ...
    defaultParams: { steps: 20 },
    costTier: 'high',
    notes: 'Via Together AI. Supports reference_images array.',
  },
  {
    id: 'google/gemini-flash-image-2.5',
    name: 'Gemini Flash Image 2.5 (Together)',
    provider: 'together',
    type: 'image',
    supportsReferenceImages: true,
    referenceImageMode: 'multi-url',
  ...
  },
  {
    ...
    name: 'Gemini 3.1 Flash Image (Together)',
    provider: 'together',
    type: 'image',
    supportsReferenceImages: true,
    referenceImageMode: 'multi-url',
